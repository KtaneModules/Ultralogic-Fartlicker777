...
public class Ultralogic : MonoBehaviour {
    ...
    void Start () {
        ...
        Debug.LogFormat("[Ultralogic #{0}] The truth values for A, B, and C are {1}, {2}, {3}.", moduleId, ABCTruthValues[0], ABCTruthValues[1], ABCTruthValues[2]);
    }
...
#pragma warning restore 414
    ...
    IEnumerator ProcessTwitchCommand (string command) {
        string[] parameters = command.ToLower().Trim().Split(' ');
        ...
        if (parameters.Length != 3 || parameters[0] != "set" || !OperatorList.Join().Contains(parameters[2])) {
